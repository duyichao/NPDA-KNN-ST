...
def get_experimental_generation_parser(interactive=False, default_task="speech_to_text_joint_mt"):
    parser = get_parser("Generation", default_task)
    add_dataset_args(parser, gen=True)
    add_distributed_training_args(parser, default_world_size=1)
    add_generation_args(parser)
...
def get_knn_generation_parser(interactive=False, default_task="speech_to_text_joint_mt"):
    parser = get_parser("Generation", default_task)
    add_dataset_args(parser, gen=True)
    add_distributed_training_args(parser, default_world_size=1)
    add_generation_args(parser)
...
def add_knn_record_args(parser):
    group = parser.add_argument_group("knn_record")
    # fmt: off
...
def add_knn_args(parser):
    ...
    # # add by yichao
    # group.add_argument("--load-knn-datastore", default=False, action="store_true")
    # group.add_argument("--use-knn-datastore", default=False, action='store_true')
    # group.add_argument("--knn-lambda-type", default="fix", type=str)
    # group.add_argument("--knn-lambda-value", default=0.1, type=float)
    # group.add_argument("--knn-temperature-type", default="fix", type=str)
    # group.add_argument("--knn-temperature-value", default=50, type=int)
